      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-32 bg-white rounded-md shadow-xl border border-gray-200 py-1 z-[9999]">
          <button
            ...
            className={`flex items-center w-full px-4 py-2 text-sm hover:bg-gray-50 transition-colors ${locale === 'en' ? 'text-blue-600 bg-blue-50' : 'text-gray-700'
              }`}
          >
            {t('english')}
          </button>
          <button
            ...
            className={`flex items-center w-full px-4 py-2 text-sm hover:bg-gray-50 transition-colors ${locale === 'zh' ? 'text-blue-600 bg-blue-50' : 'text-gray-700'
              }`}
          >
            {t('chinese')}
          </button>
